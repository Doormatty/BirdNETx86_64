...
LOG_DIR="${HOME}/BirdNETx86_64/logs"
BIRDNETDIR=/root/BirdNETx86_64/scripts
services=$(awk '/service/ && /systemctl/ && !/php/ {print $3}' ${BIRDNETDIR}/install_services.sh | sort)
...
sed -e '/PWD=/d' ${HOME}/BirdNETx86_64/birdnet.conf > ${LOG_DIR}/birdnet.conf 
...
tar --remove-files -cvpzf ${HOME}/BirdNETx86_64/logs.tar.gz ${LOG_DIR} &> /dev/null
# Finished
echo "Your compressed logs are located at ${HOME}/BirdNETx86_64/logs.tar.gz"
